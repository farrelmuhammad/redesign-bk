                ...
                <div class="flex items-center justify-between text-gray-800">
                  ...
                  <div class="flex items-center justify-center">
                    <button
                      ...
                      className="inline-block px-6 py-2 bg-[#faaf18] text-white font-extrabold tracking-wide text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-700 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out"
                    >
                      Login
                    </button>
                  </div>
