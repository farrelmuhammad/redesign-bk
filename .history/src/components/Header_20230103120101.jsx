      ...
      <div className="banner my-8 mx-4 md:mx-0">
        <div className="flex gap-4 w-full items-center justify-center">
          ...
          <img
            ...
            className="md:w-[12%] object-cover blur-[2px] md:h-[224px] bg-[#B6D4A8] rounded-l rounded-[20px] sm:hidden"
            alt=""
          />
          <img
          ...
          <img
            src="https://bkdelivery.co.id/media/slider_image/2022/12/20/iuazeo3rf9k7o7mdjfcpul.jpg"
            className="md:w-[12%] object-cover blur-[2px] md:h-[224px] bg-[#B6D4A8] rounded-r rounded-[20px] sm:hidden"
            alt=""
          />
