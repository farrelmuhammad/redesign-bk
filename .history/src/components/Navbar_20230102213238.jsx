            ...
            <div className="relative ml-3">
              <div className="flex space-x-2 justify-center">
                <button
                  ...
                  className="inline-block px-6 py-2.5 bg-[#faaf18] text-white font-flame font-medium text-xs tracking-wide leading-tight uppercase rounded shadow-md hover:bg-gray-700 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out"
                >
                  Login
                </button>
                {/* <button
