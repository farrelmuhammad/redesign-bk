          ...
          >
            <ul "flex flex-col p-4 gap-20 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
              <li>
                <a
                  href="#"
                  "block py-2 pl-3 pr-4 font-flame text-gray-300 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white"
                  aria-current="page"
                >
                  About
                </a>
