  ...
  return (
    <>
      <section className="flex flex-col mt-18 py-5 bg-[#FFF1CB]">
        ...
        <div class="flex w-full items-center flex justify-center items-center py-1 px-6">
          <div>
            <div class="max-w-xs h-[300px] flex flex-col justify-between bg-white rounded-lg border border-gray-400 mb-6 py-5 px-4">
              <div>
                ...
                <h4
                  tabindex="0"
                  class="focus:outline-none text-gray-800 font-bold font-flame font-xs-[2px] mb-3"
                >
