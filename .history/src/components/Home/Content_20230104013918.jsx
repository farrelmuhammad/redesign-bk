  ...
  return (
    <>
      <section className="flex flex-col mt-20 py-5 bg-[#FFF1CB]">
        ...
        <div "grid lg:grid-cols-3 sm:gap-3 sm:grid-cols-2 w-10/12 mx-auto justify-center items-center py-1 px-6">
          {loading && (
            <div "max-w-xs h-[300px] flex flex-col justify-between bg-white drop-shadow-xl rounded-lg border border-gray-400 mb-6 mx-auto py-5 px-4">
              <div>
                <img
                  // src={menu.image}
                  alt=""
                  "animate-pulse bg-slate-200 w-[300px] h-[200px] object-cover"
                />
                ...
                <div "flex items-center justify-end mt-2 text-gray-800">
                  <div "flex items-center justify-end">
                    ...
                    {/* <button
                      ...
                      className="animate-pulse bg-slate-200 inline-block px-6 py-2 bg-[#ED7801] text-white font-extrabold tracking-wide text-xs leading-tight uppercase rounded shadow-md hover:bg-[#faaf18] hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out"
                    >
                      Order
                    </button> */}
                  </div>
          ...
          {data.map((menu) => (
            <div
              "max-w-xs h-[300px] flex flex-col justify-between bg-white drop-shadow-xl rounded-lg border border-gray-400 mb-6 mx-auto py-5 px-4"
              key={menu.id}
            >
              <div>
                <img
                ...
                <h4
                  tabindex="0"
                  "focus:outline-none text-[#8B542F] text-xl font-flame"
                >
                  {menu.name}
                </h4>
              </div>
