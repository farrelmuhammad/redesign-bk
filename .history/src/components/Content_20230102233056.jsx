                ...
                <div class="flex items-center justify-between text-gray-800">
                  ...
                  <div class="flex items-center justify-center">
                    <button
                      ...
                      className="inline-block px-6 py-2 bg-[#ED7801] text-white font-flame tracking-wide text-sm leading-tight uppercase rounded shadow-md hover:bg-[#faaf18] hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out"
                    >
                      Order
                    </button>
                  </div>
