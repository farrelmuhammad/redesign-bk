  ...
  return (
    <>
      <section className="flex flex-col mt-18 py-5 bg-[#FFF1CB]">
        ...
        <div class="grid grid-cols-4 gap-4 my-0">
          <div>
            <div class="max-w-xs h-[300px] flex flex-col justify-between bg-white rounded-lg border border-gray-400 mb-1 py-5 px-4">
              <div>
                <img
