  ...
  return (
    <>
      <section className="flex flex-col mt-18 py-5 bg-[#FFF1CB]">
        ...
        <div "grid grid-cols-3 w-full items-center justify-center py-1 px-6 mx-10 gap-4">
          <div>
            <div "max-w-xs h-[300px] flex flex-col justify-between bg-white rounded-lg border border-gray-400 mb-6 py-5">
              <div>
                <img
